# TASK (END-TO-END): Perform a focused performance audit of Go code, identifying hot-path inefficiencies, algorithmic complexity issues, unnecessary allocations, I/O bottlenecks, and scalability limiters while rigorously preventing false positives.
