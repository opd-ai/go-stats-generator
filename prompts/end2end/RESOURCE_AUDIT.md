# TASK (END-TO-END): Perform a focused audit of resource lifecycle management in Go code, identifying file descriptor leaks, database connection leaks, unclosed handles, defer ordering issues, and cleanup failures while rigorously preventing false positives.
