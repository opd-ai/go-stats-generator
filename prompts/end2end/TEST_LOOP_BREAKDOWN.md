# TASK (END-TO-END): Execute iterative breakdown cycles on **test functions** using TEST_BREAKDOWN.md logic until no test functions exceed complexity thresholds, then halt.
