# TASK (END-TO-END): Perform a focused test quality and coverage audit of a Go project, evaluating test completeness, test design quality, coverage gaps on critical paths, flaky test risk, and test infrastructure health while rigorously preventing false positives.
