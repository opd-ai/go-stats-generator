# TASK (END-TO-END): Perform a dependency health and supply chain audit of a Go project, evaluating dependency freshness, vulnerability exposure, license compliance, maintenance status, and supply chain risk while rigorously preventing false positives.
