# TASK (END-TO-END): Perform a red team security audit of a Go project, adopting an adversarial mindset to discover exploitable vulnerabilities by simulating real attack scenarios against the project's actual deployment model and trust boundaries.
