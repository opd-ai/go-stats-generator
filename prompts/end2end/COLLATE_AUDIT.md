# TASK (END-TO-END): Discover all audit files, extract unchecked findings, enrich with metrics, and produce a single prioritized consolidated audit with an accompanying gaps analysis.
