# TASK (END-TO-END): Perform a focused code-organization and architecture audit of a Go project, evaluating library-forward design, entrypoint thinness, interface-driven boundaries, and separation of concerns while rigorously preventing false positives.
