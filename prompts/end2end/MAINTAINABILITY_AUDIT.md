# TASK (END-TO-END): Perform a code maintainability and technical debt audit of a Go project, evaluating code complexity, duplication, coupling, documentation debt, and long-term sustainability while rigorously preventing false positives.
