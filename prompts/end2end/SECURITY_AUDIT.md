# TASK (END-TO-END): Perform a focused security audit of Go code, identifying injection vulnerabilities, authentication/authorization flaws, cryptographic misuse, input validation gaps, and secrets exposure while rigorously preventing false positives.
