# TASK: [Ebitengine Edition] Perform a focused test quality and coverage audit of Ebitengine game code for a Go project, evaluating test completeness, test design quality, coverage gaps on critical paths, flaky test risk, and test infrastructure health while rigorously preventing false positives.
