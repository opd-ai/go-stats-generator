# TASK: [Ebitengine Edition] Reorganize **test file** structure using package cohesion/coupling metrics — move test code between files without modifying test logic.
