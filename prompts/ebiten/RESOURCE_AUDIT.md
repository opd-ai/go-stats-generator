# TASK: [Ebitengine Edition] Perform a focused audit of Ebitengine game code for resource lifecycle management in Go code, identifying file descriptor leaks, database connection leaks, unclosed handles, defer ordering issues, and cleanup failures while rigorously preventing false positives.
