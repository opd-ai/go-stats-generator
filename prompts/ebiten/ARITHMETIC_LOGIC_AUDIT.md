# TASK: [Ebitengine Edition] Perform a focused audit of Ebitengine game code for arithmetic and numeric logic errors in Go code, identifying integer overflow, incorrect division, sign handling bugs, precision loss, bit manipulation errors, and incorrect numeric comparisons while rigorously preventing false positives.
