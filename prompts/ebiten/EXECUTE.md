# TASK: [Ebitengine Edition] Execute as many planned tasks as possible from the target project's backlog in strict priority order: audit findings first, then planned steps, then roadmap items.
