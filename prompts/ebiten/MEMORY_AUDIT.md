# TASK: [Ebitengine Edition] Perform a focused audit of Ebitengine game code for memory management in Go code, identifying memory leaks, excessive allocations, unsafe pointer misuse, and GC pressure while rigorously preventing false positives.
