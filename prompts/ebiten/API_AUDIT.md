# TASK: [Ebitengine Edition] Perform a focused API design and contract audit of Ebitengine game code for a Go project, evaluating exported API surface quality, contract clarity, backward compatibility, documentation completeness, and consumer ergonomics while rigorously preventing false positives.
