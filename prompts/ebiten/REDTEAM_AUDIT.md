# TASK: [Ebitengine Edition] Perform a red team security audit of Ebitengine game code for a Go project, adopting an adversarial mindset to discover exploitable vulnerabilities by simulating real attack scenarios against the project's actual deployment model and trust boundaries.
