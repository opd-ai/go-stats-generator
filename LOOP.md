...
2. **Refactor**: Apply extract-method decomposition:
...
5. **Check termination conditions**:
   - **Success**: No remaining functions exceed thresholds → halt with success.
...
2. Log the failure and the function that caused it.
