...
// CalculateFileMBI computes the Maintenance Burden Index for a file
...
// CalculatePackageMBI computes the Maintenance Burden Index for a package
...
// CalculateAllScores computes MBI for all files and packages
